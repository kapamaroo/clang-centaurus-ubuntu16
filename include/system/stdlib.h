...
#ifdef __CENTAURUS__
// we define uint abs(int); and we can live with this inconcistency due to the fact that
// in __CENTAURUS__ mode we do source code transformations
//
// see __acl_sys_impl.[ch] if you want to call the system's abs()
#else
