...
#define __MATHDECL_1(type, function,suffix, args) \
  __CENTAURUS_OVERLOAD__ extern type __MATH_PRECNAME(function,suffix) args
#else
#define __MATHDECL_1(type, function,suffix, args) \
  __CENTAURUS_OVERLOAD__ extern type __MATH_PRECNAME(function,suffix) args __THROW
#endif
#else
#error custom header file NOT in Centaurus Mode!
#define __MATHDECL_1(type, function,suffix, args) \
